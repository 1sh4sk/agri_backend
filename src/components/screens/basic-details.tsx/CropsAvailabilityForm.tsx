...
const CropsPage: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'crops' | 'availability'>('crops');
      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-sm">
            ...
            <div className="flex items-center justify-between p-4 border-b border-gray-200">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">Add your Crops based on the Availability</p>
              </div>
              <button
        ...
        {activeTab === 'availability' && (
          <div className="bg-white rounded-lg shadow-sm p-6">
            <p className="text-gray-600">Availability content goes here</p>
          </div>
        )}
