...
import {
  ...
  CropsListForm,
  FarmerDetailsForm,
  IndividualBasicDetailsForm,
  IndividualOthersForm,
  KYCForm,
  LandAndCropDetailsForm,
  OthersForm,
} from "../../components/screens";
import { schemaMap } from "../../utils/yupValidation";
import { IndividualSteps as steps } from "../../constants/BasicDetailsSteps";
    ...
    <FormProvider {...methods}>
      ...
      >
        <div className="w-full h-full py-4">
          ...
          {/* SubTabs */}
          <div className="flex gap-3 border-b mt-5 mb-6 pt-4 bg-white ">
